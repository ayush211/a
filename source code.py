...
while True:
    if ch==1:
        ...
        print("+-------------+--------------------+-------------+---------------+---------+---------------+")
        print("| MOVIE_CODE  | MOVIES             | SHOW_TIME   | DATE          |   PRICE | GENRE         |")
        print("+-------------+--------------------+-------------+---------------+---------+---------------+")
        print("|      1      | Alladin            | 9am-12noon  | 20-march-2021 |     250 | FantacyFamily |")
        print("|      2      | Insepion           | 12non-3pm   | 20-march-2021 |     150 | Sci-Fi        |")
        print("|      3      | Kgf2               | 3pm-6pm     | 20-march-2021 |     200 | ActionDrama   |")
        print("|      4      | War                | 6pm-9pm     | 20-march-2021 |     150 | Action        |")
        print("|      5      | A Walk To Remember | 9pm-12pm    | 20-march-2021 |     350 | Romantic      |")
        print("+-------------+--------------------+-------------+---------------+---------+---------------+")
